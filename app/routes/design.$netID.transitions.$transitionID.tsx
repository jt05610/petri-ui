...
import { deleteTransition, getTransition } from "~/models/net.transition.server";
  ...
  return (
    <div className={"flex flex-col justify-center space-y-2 p-2"}>
      ...
      <div className={"flex flex-row flex-shrink justify-between"}>
        ...
        <NavLink to={"events"} className={"rounded-full contents-center bg-slate-600 text-white justify-center flex px-4 py-2"}>
          Events
        </NavLink>
        <Form method={"post"}>
